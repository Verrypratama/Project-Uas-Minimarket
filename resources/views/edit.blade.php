    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            @if($role=='admin')
            {
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="pegawai/{{ $role}}">
                ...
                <div class="container-fluid">
                 <!-- Page Heading -->
                    ...
                    <p class="mb-4"><a target="_blank"
                            ...
                            <form action="{{ url('editProduk/' . $role . '/' . $nama . '/' . $data->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_produk" name="nama_produk" value="{{ $data->nama_produk }}" aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="stock" name="stock" value="{{ $data->stock }}" aria-describedby="emailHelp">
                                </div>
                                        <!-- end form text field -->
