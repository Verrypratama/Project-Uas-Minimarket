        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            @if($data->role=='admin')
            {
                <li class="nav-item active">
                    <a class="nav-link" href="rekaptulasi/{{ $data->role}}">
                        <i class="fas fa-chart-line"></i>
                        <span>Rekaptulasi</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="produk/{{ $data->role}}/{{$data->nama  }}">
                        <i class="fas fa-box"></i>
                        <span>Produk</span></a>
                </li>
      
                <li class="nav-item active">
                <a class="nav-link" href="/indexPegawai/{{$data->role }}/{{$data->name }}">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Hello {{ $data->role}}</h1>
                    <p class="mb-4">Ganti deskripsi</p>
                        ...
                        <!-- Main Content -->
                            ...
                            <form action="{{ url('/updatePegawai', [$data->id, $data->role, $data->name]) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="username" name="username" value="{{ $data->username }}" aria-describedby="emailHelp">
                                ...
                                {{-- <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="password" name="password" value="{{ $data->password }}" aria-describedby="emailHelp">
